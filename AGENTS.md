...
- `docs/adr/ADR-0001-structured-cv-editor.md` y `docs/development/STRUCTURED_CV_EDITOR_PLAN.md`: diseno y plan del editor estructurado; leerlos antes de tocar DB, rutas, export/import, ATS, LaTeX/PDF o UI del modulo CV.
...
- Evitar titulos huerfanos al final de pagina, cortes pobres entre titulo y cuerpo, listas cortas partidas innecesariamente, bloques ilegibles, solapamientos y espacios vacios excesivos. Usar reservas de espacio, agrupacion de listas cortas o saltos puntuales solo cuando mejoren la lectura.
- Si se corrige paginacion o layout PDF, regenerar todos los PDFs servidos por la app y validar portada, indice y paginas internas afectadas.
